...
In order to install the _Tip of the day_ feature the _http://download.eclipse.org/eclipse/updates/4.8-I-builds_ update site can be used.

image::install-tip-of-the-day.png[] 
